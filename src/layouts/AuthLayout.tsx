      ...
      <div className="bg-[url('./src/assets/images/header.png')] bg-no-repeat bg-cover bg-center py-5" >
        <div className='flex items-center justify-center sm:justify-start sm:px-20'>
          ...
          <div className='flex flex-col items-center justify-center'>
            <p className='uppercase text-base text-[#1488D8] text-[10px] sm:text-[12px] '>đại học quốc gia thành phố hồ chí minh</p>
            <p className='uppercase font-bold text-[#030391] text-[16px] sm:text-[18px]'>trường đại học bách khoa</p>
          </div>
        </div>
      </div>
